...
"""
def index(request):
	#return HttpResponse('welcome to my pasges!')
	return render(request,'blog/index.html',context={'title':'我的主页','welcome':'welcome to my pages'})
"""
...
# 首先获得父类生成的传递给模板的字典。
	...
	def pagination_data(self, paginator, page, is_paginated):
		...
		data = {'left': left,'right': right,'left_has_more': left_has_more,'right_has_more': right_has_more,'first': first,'last': last,}
